 ...
 * The program simulates Simple Isotropic Random Walk wit Long Range Dispersal down
 ...
 * The program takes examples/testSimulatedTreeTraitMapLongRangeDispersal.xml as input arguement
 */
...
public class SimulatedTreeTraitMapLongRangeDispersal extends TreeTraitMap {
    ...
    public Input<Double> m_mu = new Input<Double>("mu", "parameter for long range dispersal (default 1.5).", 1.5);
