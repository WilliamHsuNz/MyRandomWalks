 ...
 * The program simulates Simple Isotropic Random Walk down a phylogenetic tree and
 * maps geographical location traits to the nodes of the tree.  The program then
 * performs MCMC sampliing method to infer the location of the root from the locations
 * of the leaves.
 *
 * The program is run through the main method at beast.app.beastapp.BeastMain
 * The program takes examples/testSimulatedTreeTraitMap.xml as input arguement
 */
