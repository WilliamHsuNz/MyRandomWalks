 ...
 * This Program extends on The TreeTraitMap Class from the beast-classic package.
 * The program simulates Simple Isotropic Random Walk with boundaries down a
 * phylogenetic tree and maps geographical location traits to the nodes of the tree.
 * The program then performs MCMC sampliing method to infer the location of the root
 * from the locations of the leaves.
 *
 * The program can is run through the main method at beast.app.beastapp.BeastMain
 * The program takes examples/testSimulatedTreeTraitMapWithBoundaries.xml as input arguement
 */
...
public class SimulatedTreeTraitMapWithBoundaries extends TreeTraitMap {
    ...
    public Input<Double> m_maxLatBoundaryInput = new Input<Double>("maxLatBoundary", "Maximum Latitude boundary (default 1.0).",1.0);
    public Input<Double> m_minLatBoundaryInput = new Input<Double>("minLatBoundary", "Maximum Latitude boundary (default -1.0).", -1.0);
    public Input<Double> m_maxLonBoundaryInput = new Input<Double>("maxLonBoundary", "Maximum Longitude boundary(default 1.0).", 1.0);
    public Input<Double> m_minLonBoundaryInput = new Input<Double>("minLonBoundary", "Minimum Longitude boundary(default -1.0).", -1.0);
    ...
    public void initAndValidate(){
		...
		//map location values onto the leaves
        value = "";
